...
activity_labels = read.table("C:/Coursera/UCI HAR Dataset/activity_labels.txt")[,2]

# Load data column names
features = read.table("C:/Coursera/UCI HAR Dataset/features.txt")[,2]
...
write.table(tidy_data, file = "C:/Coursera/UCI HAR Dataset/tidy_data.txt", row.name=FALSE)
